 ...
 */
public interface ReversiListener extends BoardListener {
  // currently this interface only includes features of the HexagonalBoard

  // if we want to have the features of ONLY the HexagonalBoard, we use the BoardListener interface,
  ...
  // possible future methods: gameRestarted, boardShapeSet, etc.
}
